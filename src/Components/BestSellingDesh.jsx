  ...
  return (
    <div className="bg-[#f5f2eb]">
      <div className="container mx-auto pt-[127px] pb-[117px]">
        <img src="/public/images/popularDishesShape1_1.png" className="absolute left-0 lg:mt-[565px]" alt="" />
        <img src="/public/images/popularDishesShape1_2.png" className="absolute  right-5 mt-[-50px] animate-float" alt="" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {dishes.map((dish) => (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-700 ease-in-out bg-cover bg-center"
                   style={{ backgroundImage: "url('https://i.ibb.co.com/99mz085T/freepik-upload-50378.png')" }}>
                {/* Black overlay */}
                <div className="absolute inset-0 bg-black bg-opacity-50"></div>
              </div>

              {/* Favorite Button */}
              <button className="absolute top-4 right-4 z-30 bg-white rounded-full p-2 shadow-md hover:bg-red-100 transition">
              ...
              {/* Hover Icons (just below love icon) */}
