...
const BestSellingDesh = () => {
  ...
  useEffect(() => {
    ...
    const fetchWishlist = async () => {
      try {
        const res = await axios.get(`http://localhost:5000/wishes?userId=${user._id}`);
      ...
      if (result.isConfirmed) {
        axios
          ...
          .then((res) => {
            ...
            Swal.fire("Added!", "This item has been added to your wishlist.", "success");
          })
          .catch((err) => {
        ...
        Swal.fire("Not added", "This item was not added to your wishlist.", "info");
      }
    });
  };
  ...
  return (
    <div className="bg-[#f5f2eb]">
      <div className="container mx-auto pt-[127px] pb-[117px]">
        ...
        <h2 className="text-xl font-semibold mb-4 text-center text-[#fc7819]">POPULAR DISHES</h2>
        <h2 className="text-[40px] font-bold mb-10 text-center">Best Selling Dishes</h2>
