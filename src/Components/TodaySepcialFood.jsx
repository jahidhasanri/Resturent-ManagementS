...
const TodaySepcialFood = () => {
    return (
        <div className='w-full bg-cover bg-center'  style={{ backgroundImage: "url('/public/images/ctaBG1_1.jpg')" }}>
           <div className='w-8/12 mx-auto pt-[100px] pb-[100px] flex items-center justify-between'>
                ...
                <div>
                    <img className='w-[600px] h-[400px] animate-left-right' src="/public/images/pizza.png" alt="" />
                </div>
           <img className='absolute right-2 lg:mb-[-430px] animate-float' src="/public/images/ctaShape1_3.png" alt="" />
           <img className='absolute left-0 lg:mb-[-450px] animate-float' src="/public/images/ctaShape1_2.png" alt="" />
           <img className='absolute left-2 lg:mb-[430px] animate-left-right' src="/public/images/corner-2.png" alt="" />
           </div>
