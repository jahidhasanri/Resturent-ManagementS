  ...
  return (
    <div className="mt-20">
      ...
      >
        ...
        <div className="m-[100px] border-[7px] border-[#925a13] relative z-10 bg-white rounded-xl">
          {/* Header */}
          <div
          ...
          {/* Customer Details */}
          <div className="flex flex-col md:flex-row justify-between gap-8 p-6  rounded-b-xl">
