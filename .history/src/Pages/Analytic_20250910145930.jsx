    ...
    <div className="bg-[#12121e] min-h-screen">
      <div className="py-10 xl:px-32">
        ...
        <div className="grid md:grid-cols-2 2xl:grid-cols-4 gap-6">
          <div className="grid  gap-4">
            <div className="bg-[#1c1c2e] w-[310px] xl:w-[410px] 2xl:w-[310px] mx-auto rounded-xl p-6 flex justify-between h-[165px]">
              <div>
      ...
      <div className="grid gap-4">
        <div className="bg-[#1c1c2e] w-[310px] xl:w-[410px] 2xl:w-[310px] mx-auto rounded-xl p-6 flex justify-between h-[165px]">
          ...
          {/* order (Complete Card) */}
          <div className="bg-[#1c1c2e] rounded-xl p-6 w-[310px] xl:w-[410px] 2xl:w-[310px] mx-auto items-center justify-center h-[346px]">
          ...
          {/* Subscriptions */}
          <div className="bg-[#1c1c2e] rounded-xl p-6 w-[310px] xl:w-[412px] 2xl:w-[310px] mx-auto items-center justify-center h-[346px]">
