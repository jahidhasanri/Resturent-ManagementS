          ...
          <div className="p-6 bg-black bg-opacity-80 text-white">
            ...
            <div className="">
                <div className="flex gap-2 mt-5">
                  <h3 className=" items-center text-[20px]  font-bold">Payment Status: <div className="text-green-700">{data?.paidstatus}</div></h3>
                </div>

           <div className="mt-8">
              <div className="flex gap-2 mt-5">
                <h3 className="items-center text-[20px] font-bold">
                  Payment Status:{" "}
                  <span className="text-green-700">{data?.paidstatus}</span>
                </h3>
              </div>
