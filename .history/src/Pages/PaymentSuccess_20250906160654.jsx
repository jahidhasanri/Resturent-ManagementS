            ...
            <div className="relative z-10 flex flex-col items-center justify-center">
              ...
              <div className="flex items-center justify-around">
                ...
                <div className="text-white">
                  ...
                  <h5 className="text-[16px] font-semibold"><span className="text-[16px] font-bold">Phone:</span>{shipping?.address}</h5>
                  <h5 className="text-[16px] font-semibold"><span className="text-[16px] font-bold">Phone:</span>{shipping?.city}</h5>
                </div>
              </div>
