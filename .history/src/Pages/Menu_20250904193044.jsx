  ...
  return (
    <div className="bg-[#f4f1ea]">
      ...
      <div className="container mx-auto grid grid-cols-12 gap-4">
        ...
        <div className="col-span-9 grid grid-cols-3 gap-4 p-4">
            ...
            >
              <div className="relative mx-auto w-32 h-32 pb-4">
                ...
                <img
                  src={food?.image}
                  alt={food?.name}
                  className="w-[200px] h-[163px] object-cover rounded-full z-10 relative p-2"
                />
              </div>
              <h2 className="text-lg font-bold">{food?.name}</h2>
              <div>{renderStars(food?.review || 0)}</div> 
              <p className="text-red-600 text-lg font-semibold">Price: {food?.price}</p>
            </div>
          ))}
        </div>
      </div>
