...
const PaymentSuccess = () => {
  ...
  return (
    <div className="text-center mt-20">
      ...
      <div
        className="w-6/12 h-[800px] mx-auto relative rounded-2xl overflow-hidden shadow-xl relative"
        style={{
      ...
      >
        <div className="m-[100px]  border-[10px] border-[#151515]">
        <div
        ...
        <div className="p-8 text-left">
          <p className="text-lg font-semibold">Transaction ID: <span className="font-normal">{tranId}</span></p>
          {data && (
            <>
              <p className="mt-2 text-lg font-semibold">
                Total Payment: <span className="font-normal">{data.amount} ৳</span>
              </p>
              <p className="mt-2 text-lg font-semibold">
