...
const handleDownload = () => {
  ...
  // Replace all colors with hex / rgba to prevent oklch
  element.querySelectorAll("*").forEach(el => {
    el.style.color = window.getComputedStyle(el).color.replace("oklch", "#000");
    el.style.backgroundColor = window.getComputedStyle(el).backgroundColor.replace("oklch", "#fff");
    el.style.borderColor = window.getComputedStyle(el).borderColor.replace("oklch", "#ccc");
  });
