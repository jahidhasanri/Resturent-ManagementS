    ...
    <div className="bg-[#12121e] min-h-screen">
      <div className="py-10 xl:px-32">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex gap-2 items-center">
            <img
              ...
              alt="user"
            />
            <h4 className="text-white text-[14px] px-2 font-semibold">
              {user?.name}
            </h4>
          </div>
        </div>
        ...
        <div className="grid xl:grid-cols-4 gap-6">
          <div className="grid  gap-4">
            <div className="bg-[#1c1c2e] w-[310px] mx-auto rounded-xl p-6 flex justify-between h-[165px]">
              <div>
            ...
            {/* Month total */}
            <div className="bg-[#1c1c2e] w-[310px] rounded-xl p-6 flex justify-between h-[165px]">
              <div className="">
      ...
      <div className="grid gap-4">
        <div className="bg-[#1c1c2e] w-[310px] rounded-xl p-6 flex justify-between h-[165px]">
          ...
          {/* order (Complete Card) */}
          <div className="bg-[#1c1c2e] rounded-xl p-6 w-[310px] items-center justify-center h-[346px]">
