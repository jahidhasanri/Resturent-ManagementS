        ...
        <ul className="menu bg-bar p-4 w-80 min-h-full bg-[#1d1d29] text-base-content">
          ...
          {role === "admin" && (
            <>
              ...
              <li>
                  <NavLink to={'manageDishes'} className="hover:text-red-500 cursor-pointer text-[24px] font-semibold"><div className="flex gap-3 items-center"><MdManageHistory /> AddDishes</div></NavLink>
              </li>
              <li>
                <NavLink
