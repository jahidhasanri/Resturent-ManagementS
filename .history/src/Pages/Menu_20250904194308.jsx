        ...
        <div className="col-span-9 grid lg:grid-cols-4 gap-4 p-4">
          {allDishes.map((food, idx) => (
            ...
            >
              ...
              <p className="text-red-600 text-lg font-semibold mt-2"><span className="text-bold">Price:</span> {food?.price}</p>
              </div>
              <button className=" rounded-3xl mx-auto  w-[182px] bg-[#fde5e9] text-red-600"><div className="flex gap-2 items-center p-2">Order Now <FaShoppingBasket /></div></button>
            </div>
          ))}
        </div>
      </div>
