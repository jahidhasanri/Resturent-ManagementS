        ...
        <div className="col-span-9 grid lg:grid-cols-4 gap-4 p-4">
          {allDishes.map((food, idx) => (
            ...
            >
              ...
              <button className=" rounded-3xl items-center w-[182px] bg-[#fde5e9] text-red-600"><div className="flex gap-2 text-center p-4">Order Now <FaShoppingBasket /></div></button>
            </div>
          ))}
        </div>
      </div>
