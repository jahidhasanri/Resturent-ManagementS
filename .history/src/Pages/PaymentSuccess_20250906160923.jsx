...
const PaymentSuccess = () => {
  ...
  <div className="text-white text-start">
    <h3 className="text-[20px] font-bold">Customer Details</h3>
  ...
  <div className="text-white">
    <h5 className="text-[16px] font-semibold"><span className="text-[16px] font-bold">Phone:</span> {shipping?.phoneNumber}</h5>
    <h5 className="text-[16px] font-semibold"><span className="text-[16px] font-bold">Address:</span> {shipping?.address}</h5>
    <h5 className="text-[16px] font-semibold"><span className="text-[16px] font-bold">City:</span> {shipping?.city}</h5>
  </div>
</div>
