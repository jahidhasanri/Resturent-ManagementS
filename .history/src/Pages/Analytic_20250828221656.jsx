          ...
          <div className="bg-[#1c1c2e] rounded-xl p-6  items-center justify-center h-[346px]">
           ...
           <DonutChart></DonutChart>
            <div className="flex gap-4 mt-3 text-gray-300 text-xs">
              <p><span className="text-yellow-400">●</span> 62% Completed Orders</p>
              <p><span className="text-orange-400">●</span> 30% Pending Orders</p>
              <p><span className="text-yellow-200">●</span> 8% Cancelled Orders</p>
            </div>
          </div>
