  ...
  return (
    <div className="bg-[#f7f4ed]  py-20">
      ...
      <div className="text-center mb-16">
        ...
        <h2 className="text-5xl font-bold pb-20">Meet Our Expert Chefe</h2>
      </div>

      {/* Cards */}
      <div className="w-9/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-5">
        {chefs.map((chef) => (
          <div
            key={chef.id}
          ...
          >
            {/* Image Wrapper */}
            <div className="absolute w-[310px] -top-20 left-1/2 transform -translate-x-1/2">
              <img
                src={chef.img}
                alt={chef.name}
                className={`w-full h-[290px] object-cover rounded-r-[100px] rounded-t-[100px] border-b-8 ${chef.borderColor}`}
              />
              {/* Share Button */}
              <button
            ...
            <div className="mt-32 mb-8">
              <h3 className="text-xl font-bold mt-10 mb-3">{chef.name}</h3>
