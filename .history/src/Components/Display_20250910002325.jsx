    ...
    return (
        <div className='bg-[#f5f2eb] pb-10 pt-10'>
          ...
          <div className='w-11/12 mx-auto grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6'>
            <div className='sm:w-[310px] lg:w-[570px] flex items-center  p-4 rounded-sm opacity-95'
            style={{
              backgroundImage: `url('/images/crop-plate-with-salad.jpg')`
              
            }}>
                <img src="/images/offerShape1_4.png" className='absolute ml-[150px] mb-[140px] lg:ml-[270px] lg:mb-[170px] animate-left-right' alt="" />
                <div>
            ...
            style={{
              backgroundImage: `url('/images/crop-plate-with-salad.jpg')`
                ...
                <img src="/images/offerShape1_4.png" className='absolute lg:ml-[270px] lg:mb-[170px] animate-left-right' alt="" />
                <div>
