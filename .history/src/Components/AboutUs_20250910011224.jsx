  ...
  return (
    <div className='relative pt-8 pb-8'>
      ...
      >
        ...
        <img
          className='absolute mb-[250px] ml-[380px] hidden md:block lg:hidden xl:block'
          src="/images/aboutShape1_2.png"
          alt=""
        />
        <img
          className='absolute left-10 md:left-52 md:mt-[950px] lg:hidden xl:block lg:mt-0 animate-Aspin-slow hidden md:block'
          src="/images/aboutShape1_3.png"
          alt=""
        />
        <img
          className='absolute right-10 md:right-52 md:mt-[100px] lg:hidden xl:block lg:mt-0 animate-Aspin-slow hidden md:block'
