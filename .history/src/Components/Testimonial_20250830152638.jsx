...
const Testimonial = () => {
  ...
  return (
    <div className="bg-[#181818] text-white py-20">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6 lg:px-20">
        {/* Left side - Image with play button */}
        <div className="relative">
          <img
            src="https://img.freepik.com/free-photo/side-view-female-chef-preparing-pizza_23-2148762556.jpg"
            alt="Chef cooking"
