    ...
    return (
      <div className='relative pt-8 pb-8'>
        ...
        >
          ...
          />
          <img 
            className='absolute left-10 md:left-52 animate-Aspin-slow hidden md:block'
            src="/images/aboutShape1_3.png" 
            alt="" 
          />
          <img 
            className='absolute right-10 md:right-10 md:mt-[800px] animate-Aspin-slow hidden md:block'
