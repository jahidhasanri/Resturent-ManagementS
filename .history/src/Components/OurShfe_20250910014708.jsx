...
const OurShfe = () => {
  return (
    <div className="bg-[#f7f4ed] py-16 md:py-20">
      ...
      {/* Cards */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-8 mb-10">
        {chefs.map((chef) => (
          <div
            key={chef.id}
            className="bg-white rounded-t-[150px] md:rounded-t-[200px] shadow-lg text-center relative pt-24 sm:pt-28"
          >
            {/* Image Wrapper */}
