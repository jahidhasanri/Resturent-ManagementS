  ...
  return (
    <div className="bg-[#181818] text-white ">
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-10 items-center ">
        ...
        {/* Right side - Slider */}
        <div>
          <h4 className="text-orange-500 font-semibold mb-2 lg:ml-[350px]">TESTIMONIALS</h4>
          <h2 className="text-4xl font-bold mb-10 lg:ml-[350px] text-center">What Our Clients Say</h2>
