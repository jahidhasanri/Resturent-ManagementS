      ...
      <div className='relative pt-8 pb-8'>
        ...
        >
          ...
          <div className='mb-4 lg:mb-0'>
            <img 
              className="left-0 mx-auto md:mr-[338px] 2xl:mr-[0px]"
          ...
          <div className='mt-4'>
            <img 
              className="right-0 md:ml-[335px] 2xl:ml-0" 
          ...
          <img 
            className='absolute mb-[250px] ml-[380px] hidden md:block'
            src="/images/aboutShape1_2.png" 
            alt="" 
          />
          <img 
            className='absolute left-10 md:left-52 md:mt-[950px] lg:mt-0 animate-Aspin-slow hidden md:block'
            src="/images/aboutShape1_3.png" 
            alt="" 
          />
          <img 
            className='absolute right-10 md:right-52  md:mt-[100px] animate-Aspin-slow hidden md:block'
