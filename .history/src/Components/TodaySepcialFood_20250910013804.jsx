...
const TodaySepcialFood = () => {
    return (
        <div className='w-full bg-cover bg-center'  style={{ backgroundImage: "url('/images/ctaBG1_1.jpg')" }}>
           <div className='w-8/12 mx-auto pt-[100px] pb-[100px] lg:flex items-center justify-between'>
                <div>
           ...
           <img className='absolute right-2 mb-[-200px] lg:mb-[-430px] animate-float' src="/images/ctaShape1_3.png" alt="" />
           <img className='absolute left-0 lg:mb-[-450px] animate-float' src="/images/ctaShape1_2.png" alt="" />
           <img className='absolute left-2 mb-[500px] lg:mb-[430px] animate-left-right' src="/images/corner-2.png" alt="" />
           </div>
